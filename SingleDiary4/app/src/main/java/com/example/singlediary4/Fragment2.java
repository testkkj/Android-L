...
public class Fragment2 extends Fragment {
    ...
    Context context;
    com.example.singlediary4.OnTabItemSelectedListener listener;
    com.example.singlediary4.OnRequestListener requestListener;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof com.example.singlediary4.OnTabItemSelectedListener) {
            listener = (com.example.singlediary4.OnTabItemSelectedListener) context;
        }

        if (context instanceof com.example.singlediary4.OnRequestListener) {
            requestListener = (com.example.singlediary4.OnRequestListener) context;
        }
    }
    ...
    private void initUI(ViewGroup viewGroup) {
        ...
        moodSlider = viewGroup.findViewById(R.id.sliderView);
    ...
    public void showPhotoCaptureActivity() {
        ...
        if (intent.resolveActivity(context.getPackageManager()) != null) {
            startActivityForResult(intent, com.example.singlediary4.AppConstants.REQ_PHOTO_CAPTURE);
        }
    }
    ...
    public void showPhotoSelectionActivity() {
        ...
        startActivityForResult(intent, com.example.singlediary4.AppConstants.REQ_PHOTO_SELECTION);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null) {
            switch (requestCode) {
                case com.example.singlediary4.AppConstants.REQ_PHOTO_CAPTURE:
                ...
                case com.example.singlediary4.AppConstants.REQ_PHOTO_SELECTION:
