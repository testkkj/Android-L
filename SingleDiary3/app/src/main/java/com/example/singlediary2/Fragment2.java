...
public class Fragment2 extends Fragment {
    ...
    Context context;
    com.example.singlediary3.OnTabItemSelectedListener listener;
    com.example.singlediary3.OnRequestListener requestListener;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof com.example.singlediary3.OnTabItemSelectedListener) {
            listener = (com.example.singlediary3.OnTabItemSelectedListener) context;
        }

        if (context instanceof com.example.singlediary3.OnRequestListener) {
            requestListener = (com.example.singlediary3.OnRequestListener) context;
        }
    }
        ...
        pictureImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isPhotoCaptured || isPhotoFileSaved) {
                    showDialog(com.example.singlediary3.AppConstants.CONTENT_PHOTO_EX);
                } else {
                    showDialog(com.example.singlediary3.AppConstants.CONTENT_PHOTO);
                }
            }
        });
    ...
    public void showDialog(int id) {
        ...
        switch (id) {
            case com.example.singlediary3.AppConstants.CONTENT_PHOTO:
            ...
            case com.example.singlediary3.AppConstants.CONTENT_PHOTO_EX:
                builder.setTitle("사진 메뉴 선택");
    ...
    public void showPhotoCaptureActivity() {
        ...
        if (intent.resolveActivity(context.getPackageManager()) != null) {
            startActivityForResult(intent, com.example.singlediary3.AppConstants.REQ_PHOTO_CAPTURE);
        }
    }
    ...
    public void showPhotoSelectionActivity() {
        ...
        startActivityForResult(intent, com.example.singlediary3.AppConstants.REQ_PHOTO_SELECTION);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null) {
            switch (requestCode) {
                case com.example.singlediary3.AppConstants.REQ_PHOTO_CAPTURE:
                ...
                case com.example.singlediary3.AppConstants.REQ_PHOTO_SELECTION:
